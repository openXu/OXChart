...
import com.openxu.chart.bean.PieChartBean;
...
public class PieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //请求数据
        datalist.clear();
        datalist.add(new PieChartBean(20, "IT"));
        datalist.add(new PieChartBean(10, "销售"));
        datalist.add(new PieChartBean(30, "金融"));
        datalist.add(new PieChartBean(8, "林木业"));
        datalist.add(new PieChartBean(15, "制造"));
        datalist.add(new PieChartBean(15, "农业"));
        pieChart2.setLoading(false);
        pieChart2.setChartData(PieChartBean.class, "Numner", "Name",datalist ,null);
        ...
        pieChart3.setChartData(PieChartBean.class, "Numner", "Name",datalist ,null);
        ...
        pieChart4.setChartData(PieChartBean.class, "Numner", "Name",datalist ,null);
